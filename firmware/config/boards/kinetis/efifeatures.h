...
#define PWM_FREQ_FAST 164062  /* PWM clock frequency. */
...
//#define EFI_CONSOLE_UART_DEVICE (&SD2)
//#endif
...
#define EFI_CONSOLE_RX_PIN 6
#endif
// todo: this should be detected automatically based on pin selection
#define EFI_CONSOLE_AF 2
 ...
 */
#define INTERMEDIATE_LOGGING_BUFFER_SIZE 75 /*2000*/
#define STATUS_LOGGING_BUFFER_SIZE 75 /*1800*/
#define SETTINGS_LOGGING_BUFFER_SIZE 75 /*1000*/
#define DL_OUTPUT_BUFFER 140 /*6500*/

#define UTILITY_THREAD_STACK_SIZE 100 /*400*/
...
#define debugLog(fmt,...) { \
	...
	if (__debugEnabled) { \
		extern char __debugBuffer[60]; \
		chsnprintf(__debugBuffer, sizeof(__debugBuffer), fmt, ##__VA_ARGS__); \
		size_t transferred = strlen(__debugBuffer); \
		uartSendTimeout(&UARTD2, &transferred, (const void *)__debugBuffer, TIME_MS2I(1000)); \
	} \
}
