...
#define PAL_MODE_ALTERNATE(x)       (PAL_MODE_ALTERNATIVE_1 + x - 1)
#else
 ...
 */
#define PAL_PORT_INDEX(port)                                                \
  (((uint32_t)port - PORTA_BASE) >> 12)
...
#define KINETIS_GPIO_NUM_PORTS 5
#define KINETIS_GPIO_NUM_PADS  16
#define KINETIS_GPIO_NUM_LINES (/*KINETIS_GPIO_NUM_PORTS * */KINETIS_GPIO_NUM_PADS)
...
#define pal_lld_get_pad_event(port, pad)                                    \
  &_pal_events[/*PAL_PORT_INDEX(port) * KINETIS_GPIO_NUM_PADS + */(pad)]
...
extern palevent_t _pal_events[KINETIS_GPIO_NUM_LINES];
#endif /* PAL_USE_WAIT */
