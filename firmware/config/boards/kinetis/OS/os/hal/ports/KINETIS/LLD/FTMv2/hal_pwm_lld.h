...
#if !defined(KINETIS_PWM_USE_FTM3)
...
/**
 * @brief   FTM3 interrupt priority level setting.
 */
#if !defined(KINETIS_PWM_FTM3_PRIORITY) || defined(__DOXYGEN__)
#define KINETIS_PWM_FTM3_PRIORITY        12
#endif
...
#if !KINETIS_PWM_USE_FTM0 && !KINETIS_PWM_USE_FTM1 && !KINETIS_PWM_USE_FTM2 && !KINETIS_PWM_USE_FTM3
...
typedef struct {
  ...
  /* End of the mandatory fields.*/
  /* [andreika]: these are STM32-compatible */
  /**
